...
Session refresh and route protection live in `proxy.ts` (project root — this Next.js fork renamed Middleware to Proxy). The OAuth/email callback lands in `src/app/auth/callback/route.ts`.
